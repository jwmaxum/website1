...
export function LandingPage() {
  ...
  return (
    <div className="bg-[#050505] text-[#FAFAFA] min-h-screen selection:bg-[#D81B60] selection:text-white pt-20">
      {/* 1. Signature Collection (Luxury Masonry Layout) - Shopping Mall Entrance */}
      <section className="py-16 md:py-24 px-6 md:px-12 max-w-[1536px] mx-auto">
